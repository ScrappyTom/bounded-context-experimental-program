...
| Durable work-product accumulation | Most navigation and Ceiba treatments exposed whole-artifact mutation. The fresh research task wrote its whole memo on the last call. Sister studies tested staged transactions and whole-file expression, not partial work as durable cognition across turnover. E38's final apparatus gate qualified bootstrap and joint-state expression of a bounded evidence-integration record at 655 and 734 tokens, but no actor consumed it. | No clean cross-world utility test of independently evaluable incremental work as external cognition. | Major gap with expression feasibility now locally established. Explore it inside an ingress×work whole-system contrast, not as an isolated note test. |
...
- whether incremental exact work can carry cognition across information
  turnover;
