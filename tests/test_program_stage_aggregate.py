...
class ProgramStageAggregateTests(unittest.TestCase):
    ...
    def test_declared_aggregate_passes(self):
        ...
        self.assertEqual(73, result["successor_stages"])
        self.assertEqual(715, result["follow_on_model_calls"])
        self.assertEqual(9_250_473, result["follow_on_serialized_tokens"])
        self.assertEqual(68, result["unique_cited_experiment_commits"])
