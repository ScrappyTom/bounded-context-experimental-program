...
class ProgramStageAggregateTests(unittest.TestCase):
    ...
    def test_declared_aggregate_passes(self):
        ...
        self.assertEqual(67, result["successor_stages"])
        self.assertEqual(634, result["follow_on_model_calls"])
        self.assertEqual(8_213_387, result["follow_on_serialized_tokens"])
        self.assertEqual(62, result["unique_cited_experiment_commits"])
