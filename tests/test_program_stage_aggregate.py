...
class ProgramStageAggregateTests(unittest.TestCase):
    ...
    def test_declared_aggregate_passes(self):
        ...
        self.assertEqual(41, result["successor_stages"])
        self.assertEqual(473, result["follow_on_model_calls"])
        self.assertEqual(5_939_514, result["follow_on_serialized_tokens"])
        self.assertEqual(37, result["unique_cited_experiment_commits"])
