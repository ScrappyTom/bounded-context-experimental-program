...
class ProgramStageAggregateTests(unittest.TestCase):
    ...
    def test_declared_aggregate_passes(self):
        ...
        self.assertEqual(26, result["successor_stages"])
        self.assertEqual(84, result["follow_on_model_calls"])
        self.assertEqual(1_637_191, result["follow_on_serialized_tokens"])
        self.assertEqual(22, result["unique_cited_experiment_commits"])
