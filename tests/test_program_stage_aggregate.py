...
class ProgramStageAggregateTests(unittest.TestCase):
    ...
    def test_declared_aggregate_passes(self):
        ...
        self.assertEqual(71, result["successor_stages"])
        self.assertEqual(697, result["follow_on_model_calls"])
        self.assertEqual(9_051_728, result["follow_on_serialized_tokens"])
        self.assertEqual(66, result["unique_cited_experiment_commits"])
