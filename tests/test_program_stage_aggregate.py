...
class ProgramStageAggregateTests(unittest.TestCase):
    ...
    def test_declared_aggregate_passes(self):
        ...
        self.assertEqual(44, result["successor_stages"])
        self.assertEqual(552, result["follow_on_model_calls"])
        self.assertEqual(7_022_958, result["follow_on_serialized_tokens"])
        self.assertEqual(40, result["unique_cited_experiment_commits"])
