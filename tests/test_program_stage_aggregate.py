...
class ProgramStageAggregateTests(unittest.TestCase):
    ...
    def test_declared_aggregate_passes(self):
        ...
        self.assertEqual(38, result["successor_stages"])
        self.assertEqual(471, result["follow_on_model_calls"])
        self.assertEqual(5_922_096, result["follow_on_serialized_tokens"])
        self.assertEqual(34, result["unique_cited_experiment_commits"])
