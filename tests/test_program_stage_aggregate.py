...
class ProgramStageAggregateTests(unittest.TestCase):
    ...
    def test_declared_aggregate_passes(self):
        ...
        self.assertEqual(52, result["successor_stages"])
        self.assertEqual(566, result["follow_on_model_calls"])
        self.assertEqual(7_188_914, result["follow_on_serialized_tokens"])
        self.assertEqual(47, result["unique_cited_experiment_commits"])
