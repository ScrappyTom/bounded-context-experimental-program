...
class ProgramStageAggregateTests(unittest.TestCase):
    ...
    def test_declared_aggregate_passes(self):
        ...
        self.assertEqual(68, result["successor_stages"])
        self.assertEqual(688, result["follow_on_model_calls"])
        self.assertEqual(8_949_719, result["follow_on_serialized_tokens"])
        self.assertEqual(63, result["unique_cited_experiment_commits"])
