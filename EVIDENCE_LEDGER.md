...
| E26 | AF | candidate-bound adjudication consistency | A reusable offline checker reconciled all four dispositions for the standalone mutated navigation candidate and scanned 60 machine-scored occurrences covering 22 unique candidate/task groups in the older Qwen3.8 bank. The superseded H05 13/13 record is preserved but inactive; zero active conflicts remain. | Consistency and custody result, not proof that any rubric is semantically complete. Free-form claims without candidate/task bindings are outside this receipt. | [consistency audit](audits/ARTIFACT_ADJUDICATION_CONSISTENCY_AUDIT.md) |
...
closure or artifact-quality claim, bind candidate/tree identity, task version,
evaluation basis, and evidence coverage; reconcile prior dispositions; and stop
on an unexplained active conflict. `E26` is the current zero-conflict receipt.
